...
GoogleSignin.configure({
  webClientId:
    "84798314876-4psmao69rp1l6olk5m4nrndfsgfnbhpr.apps.googleusercontent.com",
  offlineAccess: true,
});
    ...
    >
      <View className="flex-1 justify-center px-6 py-12">
        ...
        <View className="mb-8 items-center">
          <View className="mb-5 h-20 w-20 items-center justify-center rounded-3xl bg-black">
        ...
        {/* Everything from here down is the "input section" that scrolls
            up as one block the moment the keyboard opens. */}
        <View>
          {/* Google Sign In */}
          <Pressable
            onPress={handleGoogleSignIn}
            disabled={anyLoading}
            className="mb-5 h-14 gap-3 flex-row items-center justify-center rounded-2xl border border-gray-200 bg-white"
          >
            {googleLoading ? (
          ...
          <View className="mb-5">
            ...
            <View className="relative justify-center">
              <TextInput
                ...
                autoCorrect={false}
                editable={!anyLoading}
                className="h-14 rounded-2xl border border-gray-200 bg-gray-50 px-4 pr-12 text-base text-gray-900"
              />
              <Pressable
          ...
          <Pressable
            ...
            className={`h-14 items-center justify-center rounded-2xl ${
              anyLoading ? "bg-gray-400" : "bg-black"
            }`}
          >
            {loading ? (
